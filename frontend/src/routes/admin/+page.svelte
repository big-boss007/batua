<script lang="ts">
  ...
  import { Button, Card, Shimmer } from '@juspay/svelte-ui-components';
...
<div class="dashboard">
  ...
  {:else if dashboard !== null}
    ...
    <div class="metrics-grid">
      <MetricCard label="Active customers" value={dashboard.active_customers} metricType="number" />
      <MetricCard
        label="Active {pName}"
      ...
      <MetricCard
        ...
        subColor="var(--color-text-muted)"
      />
      <MetricCard label="Redemptions" value={dashboard.redemption_count} metricType="number" />
    </div>
  {/if}

  <section class="quick-actions">
    <h3 class="section-title">Quick actions</h3>
    <Card classes="quick-actions-card">
